...
public final class TextBlocks {
    ...
    public static final String ACT_TWO_SCENE_TWO_ENTRY_TWO_LIGHTS = "You route the power to the lights. They slowly reach full brightness. In the distance " +
        "you see darkness inching towards you as the blubs overload and shatter. As the lightblub above you shatters, electricity flows through the connecting " +
    ...
    public static final String ACT_TWO_SCENE_TWO_ENTRY_THREE = "As you walk through the hallway in front of you, you notice two main pathways. The first " +
        ...
        "distance into each of the passages. Down the path to the helm the darkness blocking your sight started to dissapate. In the passage to reactor, you " +
    ...
    public static final String ACT_THREE_HELM_SCENE_ONE_ENTRY_TWO_BLACK_BOX_PART_ONE = "Deciding that finding the black box is the most urgent priority, you walk " +
        "in the direction which the ship's schematic shows that it would be. While walking your suit recieves an incomming transmission, accepting it " +
    ...
    public static final String ACT_THREE_HELM_FIGHT_REPAIRS = "It doesn't look good. A thick black ichor seeps from the holes in your arm. You try to stand " +
        "up, but your strength leaves you. You can do nothing but lie on the ground, as the the poison from that monster slowly ends your life.";
    ...
    public static final String ACT_THREE_BLACK_BOX_ENDING = "You make it to the freighter's central console. Nearby you find the black box and download the " +
        ...
        "back to your station, you will upload the frieghter's black box data to the Ranger's database to have it analized, but for now you slouch back in " +
    ...
    "and bash it into where the monster's head would be. The survivor collapses to the floor.";
    ...
    "retrieve the data on the black box and the place to trigger the self destruct coutdown.";
